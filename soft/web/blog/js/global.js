...
//		stickyUpdate();
//	});
//	makeSticky( $('.nav-container'), "top", -85);
//	
...
//	console.log("adding smooth scrolling...");
//	$("a[href^='#']").click(function(e) {
		// If href begins with '#', then do this.
//		console.log("intercepted hash click.  smooth scrolling...");
...
console.log( "container: " + h1 + ", viewport: " + h2 );
if(h1<h2) {
    // container is shorter than browser viewport
    $("#container").css("height", h2);
}
*/
