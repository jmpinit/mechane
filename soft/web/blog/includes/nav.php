<div class="blog-header hide-for-small">
	<div class="row" style="max-width: none;">
		...
		<a class="scroll" href="#splash"><h4 class="left-button" id="top-button">top</h4></a>

		<a class="scroll" href="#contact-me"><h4 class="right-button" id="contact-button">contact</h4></a>
		<a class="scroll" href="#work"><h4 class="right-button" id="process-button">draw</h4></a>
		<a class="scroll" href="#process"><h4 class="right-button" id="work-button">what?</h4></a>
